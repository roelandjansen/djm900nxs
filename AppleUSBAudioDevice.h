...
#ifndef _DJM01AudioDEVICE_H
#define _DJM01AudioDEVICE_H
...
class DJM01AudioDevice : public IOAudioDevice {
    OSDeclareDefaultStructors (DJM01AudioDevice);
...
protected:
	DJMConfigurationDictionary *		mConfigDictionary;
	...
	OSArray *							mMonoControlsArray;		// this flag is set by DJM01AudioEngine::performFormatChange
	...
	DJM01AudioEngine *				mFailingAudioEngine;
	// [rdar://5355808]
	DJM01AudioEngine *				mEngineToRestart;
...
public:
	...
	static	void			initHardwareThread (DJM01AudioDevice * aua, void * provider);	//  <rdar://problem/6686515>
	...
	virtual OSArray *		getOptimalClockPath ( DJM01AudioEngine * thisEngine, UInt8 streamInterface, UInt8 altSetting, UInt32 sampleRate, Boolean * otherEngineNeedSampleRateChange, UInt8 * clockPathGroupIndex = NULL );	// [rdar://4867843], <rdar://5811247>
	...
	virtual UInt32			determineClockPathUnitUsage ( DJM01AudioEngine * thisEngine, OSArray * thisClockPath );																			// [rdar://4867843]
	...
	virtual	IOReturn		registerEngineInfo (DJM01AudioEngine * usbAudioEngine);		//	<rdar://6420832>
	virtual	SInt32			getEngineInfoIndex (DJM01AudioEngine * inAudioEngine);
	...
	virtual	IOReturn		doPlaythroughSetup (DJM01AudioEngine * usbAudioEngine, OSArray * playThroughPaths, UInt8 interfaceNum, UInt8 altSettingNum, UInt8 inputTerminalID);	//	<rdar://5366067>
	...
	virtual	void			addVolumeControls (DJM01AudioEngine * usbAudioEngine, UInt8 featureUnitID, UInt8 terminalID, UInt8 interfaceNum, UInt8 altSettingNum, UInt32 usage);	// <rdar://6413207>
	virtual	void			addMuteControl (DJM01AudioEngine * usbAudioEngine, UInt8 featureUnitID, UInt8 terminalID, UInt8 interfaceNum, UInt8 altSettingNum, UInt32 usage);	// <rdar://6413207>
	...
	virtual DJMConfigurationDictionary *	getConfigDictionary (void) {return mConfigDictionary;}
	...
	static	IOReturn		deviceRequest (IOUSBDevRequest * request, DJM01AudioDevice * self, IOUSBCompletion * completion = 0);
	...
	virtual void			setShouldSyncSampleRates (DJM01AudioEngine * problemEngine) {mFailingAudioEngine = problemEngine;};
	// [rdar://5355808]
	virtual void			setShouldResetEngine ( DJM01AudioEngine * problemEngine ) { mEngineToRestart = problemEngine; };
	
	virtual	DJM01AudioEngine * otherEngine (DJM01AudioEngine * thisEngine);
	virtual IOReturn		getBothEngines (DJM01AudioEngine ** firstEngine, DJM01AudioEngine ** secondEngine);
	...
	// This is how DJM01Audio attempts device recovery.
