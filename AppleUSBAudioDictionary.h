...
#ifndef __DJM01AudioDictionary__
#define __DJM01AudioDictionary__
...
class DJM01AudioDictionary : public OSDictionary 
{
	OSDeclareDefaultStructors (DJM01AudioDictionary);
...
class DJM01UnitDictionary : public DJM01AudioDictionary 
{
    OSDeclareDefaultStructors (DJM01UnitDictionary);
...
class AUAInputTerminalDictionary : public DJM01UnitDictionary 
{
//private:
//	UInt16						terminalType;
...
class AUAOutputTerminalDictionary : public DJM01UnitDictionary 
{
//private:
//	UInt16						terminalType;
//	UInt8						assocTerminal;
...
class AUAMixerUnitDictionary : public DJM01UnitDictionary 
{
//private:
...
class AUASelectorUnitDictionary : public DJM01UnitDictionary 
{
//private:
//	UInt8 *						baSourceIDs;		// there are numInPins of these
//	UInt8						numInPins;
...
class AUAEffectUnitDictionary : public DJM01UnitDictionary 
{
//private:
//	UInt8 *						bmaControls;
//	UInt8						controlSize;
...
class AUAProcessingUnitDictionary : public DJM01UnitDictionary 
{
//private:
//	UInt8 *						bmControls;			// you don't know the size of this, calculate it using bLength and numInPins
//	UInt8 *						baSourceIDs;		// there are numInPins of these
...
class AUAExtensionUnitDictionary : public DJM01UnitDictionary 
{
//private:
//	UInt8 *						bmControls;			// you don't know the size of this, calculate it using bLength and numInPins
//	UInt8 *						baSourceIDs;		// there are numInPins of these
...
class AUAFeatureUnitDictionary : public DJM01UnitDictionary 
{
//private:
//	UInt8 *						bmaControls;
//	UInt8						controlSize;
...
class AUAClockSourceDictionary : public DJM01UnitDictionary 
{
public:
...
class AUAClockSelectorDictionary : public DJM01UnitDictionary 
{
public:
	IOReturn					getNumInPins (UInt8 * numInPins) {return getDictionaryValue (kNumInPins, numInPins);}
...
class AUAClockMultiplierDictionary : public DJM01UnitDictionary 
{
public:
...
class DJM01EndpointDictionary;

class DJM01ControlDictionary : public DJM01AudioDictionary 
{
	friend class DJMConfigurationDictionary;

    OSDeclareDefaultStructors (DJM01ControlDictionary);
...
//    UInt8						numStreamInterfaces;	
	...
	DJM01UnitDictionary *					getUnitDictionary (UInt8 unitID);
...
public:
    static DJM01ControlDictionary *		create (void);
	...
	DJM01EndpointDictionary *		getIndexedEndpointDictionary (UInt8 index);
...
class DJM01EndpointDictionary : public DJM01AudioDictionary 
{
    OSDeclareDefaultStructors (DJM01EndpointDictionary);
...
public:
    static DJM01EndpointDictionary * 	create (void);
...
class AUAASEndpointDictionary : public DJM01EndpointDictionary 
{
//private:
...
class DJM01StreamDictionary : public DJM01AudioDictionary 
{
	friend class DJMConfigurationDictionary;

    OSDeclareDefaultStructors (DJM01StreamDictionary);
...
//  UInt8						terminalLink;
	...
	DJM01EndpointDictionary *			getEndpointByAddress (UInt8 address);
    DJM01EndpointDictionary *			getIndexedEndpointDictionary (UInt8 index);
    AUAASEndpointDictionary *		getIndexedASIsocEndpointDictionary (UInt8 index);
    DJM01EndpointDictionary *			getEndpointDictionaryByAddress (UInt8 address);
...
public:
    static DJM01StreamDictionary *		create (void);
...
class DJMConfigurationDictionary : public DJM01AudioDictionary 
{
    OSDeclareDefaultStructors (DJMConfigurationDictionary);
...
public:
    static DJMConfigurationDictionary *	create (const IOUSBConfigurationDescriptor * newConfigurationDescriptor, UInt8 controlInterfaceNum);
...
private:
	...
	DJM01ControlDictionary *			getControlDictionary (UInt8 interfaceNum, UInt8 altSettingID);
	OSArray *						getStreamDictionaries (void) {return getDictionaryArray (kStreamDictionaries);}
    DJM01StreamDictionary *			getStreamDictionary (UInt8 interfaceNum, UInt8 altSettingID);
