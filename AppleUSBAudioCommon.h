...
//--------------------------------------------------------------------------------
//
//	File:		DJM01AudioCommon.h
//
//	Contains:	Various debug switches for the DJM01Audio project
//
//	Technology:	OS X
//
//--------------------------------------------------------------------------------

#ifndef _DJM01AudioCOMMON_H
#define _DJM01AudioCOMMON_H
...
// Following are a list of precompiler variables that affect the way that DJM01Audio executes, logs, and compiles.
...
// kMinimumSyncRefreshInterval is the smallest log base 2 amount of time in ms DJM01Audio will honor for a sync endppoint
...
//  Default length of DJM01AudioDevice timer interval in milliseconds
#define kRefreshInterval			128

// The following return codes are used by DJM01AudioDevice to detail the status of a format change.
enum 
{
