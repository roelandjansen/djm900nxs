...
#ifndef _DJM01AudioSTREAM_H
#define _DJM01AudioSTREAM_H
...
class DJM01AudioPlugin;

class DJM01AudioStream : public IOAudioStream {
    friend class DJM01AudioDevice;
    friend class DJM01AudioEngine;

    OSDeclareDefaultStructors (DJM01AudioStream);

public:
    virtual bool initWithAudioEngine(DJM01AudioDevice * device, DJM01AudioEngine *engine, UInt16 interfaceNumber, IOAudioSampleRate sampleRate, const char *streamDescription = NULL, OSDictionary *properties = 0);
//    virtual bool initWithAudioEngine(DJM01AudioDevice * device, DJM01AudioEngine *engine, IOUSBInterface * streamInterface, IOAudioSampleRate sampleRate, const char *streamDescription = NULL, OSDictionary *properties = 0);
    virtual void free ();
//    virtual bool initHardware (IOService *provider);
	...
	virtual void registerPlugin (DJM01AudioPlugin * thePlugin);
	static void	pluginLoaded (DJM01AudioStream * usbAudioStreamObject);
...
protected:
	...
	DJM01AudioDevice *				mUSBAudioDevice;
	DJM01AudioEngine *				mUSBAudioEngine;
	...
	IOReturn	addAvailableFormats (DJMConfigurationDictionary * configDictionary);
	IOReturn	checkForFeedbackEndpoint (DJMConfigurationDictionary * configDictionary);
...
class DJM01AudioStreamNode : public IOService 					//<radr://6686515>
{
    OSDeclareDefaultStructors ( DJM01AudioStreamNode );
