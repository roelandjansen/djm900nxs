...
#ifndef _DJM01AudioENGINE_H
#define _DJM01AudioENGINE_H
...
typedef struct FrameListWriteInfo {
    DJM01AudioEngine *				audioEngine;
    UInt32								frameListNum;
    UInt32								retryCount;
} FrameListWriteInfo;
*/

class DJM01AudioEngine : public IOAudioEngine {
    friend class DJM01AudioDevice;
    friend class DJM01AudioStream;

    OSDeclareDefaultStructors (DJM01AudioEngine);
...
public:
	...
	static void	pluginLoaded (DJM01AudioEngine * usbAudioEngineObject);
...
protected:
	...
	DJM01AudioStream *				mMainOutputStream;
	DJM01AudioStream *				mMainInputStream;
